...
2. Install the dependencies:
	...
	Ubuntu:
	```
	sudo apt install perl libdatetime-perl libfile-extattr-perl libdigest-md5-file-perl
	```
...
### Additonal dependencies for tests

```
sudo apt install bindfs libtest-most-perl libipc-run-perl
```
